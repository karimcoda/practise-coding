...
<style>
  .btn{wisth:20px;height:20px;padding:10px;background-color:#ccc;}
</style>
<ul>
  <li>
    <h3>How to Create Masonry Layout With Grid Layout System (HTML&CSS)</h3>
    <a href="https://www.youtube.com/watch?v=NFhXVnoT1a0&list=PLXdJCw6-rp7nIqS6wigK5eebXQwFyPhTY" class="btn">Link To Watch</a>
  </li>
  <li>
